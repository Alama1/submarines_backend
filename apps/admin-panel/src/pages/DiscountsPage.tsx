...
export const DiscountsPage: React.FC = () => {
  ...
  return (
    <div className="space-y-6">
      <div>
        <h2 className="text-xl font-bold text-white mb-1">Bulk Discount Thresholds</h2>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
        ...
        <div className="bg-slate-900 border border-slate-800 rounded-xl p-5 shadow-sm space-y-4">
          ...
          <form onSubmit={handleCreate} className="space-y-3 text-xs">
            <div>
              <label className="block text-slate-400 mb-1">Parts Quantity Threshold (units)</label>
              <input
                type="number"
                min="1"
                step="1"
        ...
        {/* Existing Tiers List */}
        <div className="md:col-span-2 bg-slate-900 border border-slate-800 rounded-xl overflow-hidden shadow-sm">
              ...
              {isLoading ? (
                ...
                discountList.map((tier) => (
                  <tr key={tier.id} className="hover:bg-slate-800/40 transition">
                    ...
                    <td className="px-5 py-3.5 font-mono text-emerald-400 font-bold text-sm">
